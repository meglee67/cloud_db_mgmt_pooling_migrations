# this code is copied and modified from https://github.com/hantswilliams/HHA_504_2023/blob/main/WK4/code/migrations/gcp.py
## Part 1 - Define SQLAlchemy models for patients and their insurance records:
